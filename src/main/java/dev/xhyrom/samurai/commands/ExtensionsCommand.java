        ...
        setDefaultExecutor((sender, context) -> {
            ...
            sender.sendMessage(MiniMessage.miniMessage().deserialize(
                    ...
                    Placeholder.parsed("extensions", extensions.stream().map(e -> {
                        ...
                        builder.append("Authors: " + Arrays.stream(e.getAuthors()).reduce((a, b) -> a + ", " + b).orElse("none"));
                        builder.append("\n");
                        builder.append("Version: " + e.getVersion());
                        builder.append("\n");
                        builder.append("Entrypoint: " + e.getEntrypoint());
                        builder.append("\n");
                        builder.append("Dependencies: " + Arrays.stream(e.getDependencies()).reduce((a, b) -> a + ", " + b).orElse("none"));
